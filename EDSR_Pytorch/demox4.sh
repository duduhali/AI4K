...
# C:/Python37/python main.py --model EDSR --scale 4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --batch_size 60 --save edsrtencent_x4 --dir_data ../datasets/ --reset --ext sep_reset
# C:/Python37/python main.py --model EDSR --scale 4 --n_resblocks 32 --n_feats 256 --res_scale 0.1 --batch_size 60 --save edsrtencent_x4 --dir_data E:/AI+4K/ --reset --ext sep_reset
